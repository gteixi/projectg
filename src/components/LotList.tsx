  ...
  return (
    <ul className="flex flex-col gap-1.5">
      {lots.map((lot) => {
        ...
        return (
          <li key={lot.log_id} className={`grid grid-cols-[1fr_auto] items-center text-sm py-2 px-3 rounded-lg border border-[#e5e3de]/60 border-l-[3px] ${borderColor[s]} bg-white`}>
